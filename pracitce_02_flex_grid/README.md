...
1. CSS Flexbox basics
  - на странице есть контейнер `div.flexContainer` с цветными квадратами, они размещены один под другим. Нужно разместить в одну строку.
...
2. CSS Flexbox. Перенос строки
  ...
  - добавить еще 4 квадрата в контейнер, сделать это в разметке (index.html). Сделать так, чтобы квадраты переносились на след.строку, если не помещаются в одну.

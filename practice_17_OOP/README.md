...
6. Добавляем функциональности. Реализуем методы:
 - `incMajor` - увеличить major на 1, а в minor и patch поставить 0.
 - `incMinor` - увеличить minor на 1, а в patch поставить 0.
 - `incPatch` - увеличить patch на 1.
7. Реализуем возможность истории версий. Нам нужно вести историю версий, т.е. при каждом изменении версии (вызове метода incMajor, incMinor, incPatch) сохранять текущую версию.
